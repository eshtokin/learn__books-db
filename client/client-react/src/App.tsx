  ...
  return (
    <div className="App">
      ...
      <Switch>
        ...
        <Route path='/book-manager' component={BookManager} /> {/* Protected */}
        <Route path='/filtered' component={FilteredBook} />
        <Route path='/user-manager' component={UserManager} /> {/* Protected */}
        <Route exact path='/profile' component={Profile} /> {/* Protected */}
        <Route path='/profile/favorites' component={Favorites} /> {/* Protected */}
